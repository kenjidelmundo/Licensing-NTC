...
{
    [Table("accessSROP", Schema = "dbo")]
    public class AccessSROP
    {
        [Key]
        [Column("ID")]
        ...
        [Column("CertOfCompletionSerialSROP", TypeName = "varchar(255)")]
        public string? CertOfCompletionSerialSROP { get; set; }
